...
from .siql import SIQLPolicy, IQLPolicy
...
class IQLCommandModePolicy(IQLPolicy, EpsCommandModePolicy):
    pass


@POLICY_REGISTRY.register('siql_command')
class SIQLCommandModePolicy(SIQLPolicy, EpsCommandModePolicy):
    pass
